...
//! writes `DIR/member0.img`, `DIR/member1.img`, … with sealed labels and
//! three uberblocks each.

use std::path::PathBuf;

use zfs_read::fixture::Pool;
...
fn main() {
    ...
    for i in 0..pool.members.len() {
        ...
        std::fs::write(&p, pool.member_image(i, 64 * 1024 * 1024)).expect("write");
        println!("{}", p.display());
    }
}
